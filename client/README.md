...
Builds the frontend and serves everything at **http://localhost:5001**

Or for API-only (with frontend dev server):

```bash
npm start
```

### 5.4 Demo Credentials
...
| Use | Description | URL / Attribution |
|-----|-------------|-------------------|
